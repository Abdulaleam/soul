...
public class RefinerScreenHandler extends ScreenHandler {
    ...
    private final RefinerBlockEntity blockEntity;

    public RefinerScreenHandler(int syncId, PlayerInventory inventory, BlockPos pos) {
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(pos), new ArrayPropertyDelegate(2));
    }
    public RefinerScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity blockEntity, PropertyDelegate arrayPropertyDelegate) {
    ...
    public int getScaltedArrowProgress() {
